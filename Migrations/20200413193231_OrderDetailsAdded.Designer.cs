...
namespace KavyaPieShop.Migrations
{
    ...
    [Migration("20200413193231_OrderDetailsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KavyaPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("KavyaPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("KavyaPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("KavyaPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KavyaPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("KavyaPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("KavyaPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KavyaPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KavyaPieShop.Models.Pie", b =>
                {
                    b.HasOne("KavyaPieShop.Models.Category", "Category")
                        .WithMany("Pies")
